...
//计算speedup方式有一点差异，其他差不多
public class OnlineCacheAwareRobust_v2_2 extends AllocationMethods {

	/*
	 * Multi-DAG support
	 */
	// @Override
	// public void allocate(List<DirectedAcyclicGraph> dags, List<Node>
	// readyNodes, List<List<Node>> localRunqueue, List<Integer> cores,
	// long[] coreTime, List<List<Node>> history_level1, List<List<Node>>
	// history_level2, List<Node> history_level3,
	// List<List<Node>> allocHistory, RecencyProfileSyn table, long systemTime,
	// boolean lcif) {
	//
	...
	// }
	//
	// dagID.sort((c1, c2) -> Utils.compareDAG(dags,
	// Integer.parseInt(c1.split("_")[0]), Integer.parseInt(c1.split("_")[1]),
