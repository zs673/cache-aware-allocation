...
//
//public class CacheAwareAlloc2 extends AllocationMethod {
//
//	@Override
//	public void getEligibileNode(List<DirectedAcyclicGraph> dags, List<Node> readyNodes, List<Integer> availableProcs,
//			long[] availableTimeAllProcs, List<List<Node>> history_level1, List<List<Node>> history_level2, List<Node> history_level3,
...
//
//					long WCET = n.getWCET();
//					long realET = table.computeET(history_level1, history_level2, history_level3, n, proc, true, false).getFirst();
...
//					// table.computeET(history_level1, history_level2,
//					// history_level3, n, proc, true))) / (double) n.getWCET();
//
//					/*
...
//					availableP, availableTimeAllProcs, table, currentTime, affinity);
//
//			// if (p == null)
//			// break;
//
...
//			long[] availableTimeAllProcs, Recency table, long time, boolean affinity) {
//
//		int row = -1;
//		int col = -1;
...
//				}
//
//				long maxNodes = Collections.max(NodeHis);
//				int procIndexWithMaxNodes = NodeHis.indexOf(maxNodes);
//
//				int timeCount = 0;
//				for (Long l : NodeHis) {
//					if (l == maxNodes)
...
//
//				if (timeCount == 0) {
//					col = freeProcIndex.get(procIndexWithMaxNodes);
//				} else {
//
