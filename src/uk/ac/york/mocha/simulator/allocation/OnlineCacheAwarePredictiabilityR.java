...
public class OnlineCacheAwarePredictiabilityR extends AllocationMethods {
...
//
//			Pair<Integer, Integer> p = setPartition(speedUpTable, allocNodes, allocProcs, readyNodes, cores, coreTime, systemTime, lcif,
...
//			List<Node> readyNodes, List<Integer> cores, long[] coreTime, long systemTime, boolean lcif, List<List<Node>> history_level1,
...
//					for (Node affected : affectedNodes) {
//
//						long affectedTimeOneNode = affected.crp.computeET(-1, history_level1, history_level2, history_level3, affected,
//								affected.partition, true, et_n, 0, false).getFirst().getFirst()
//								- affected.crp.computeET(-1, history_level1, history_level2, history_level3, affected, affected.partition,
...
//	}
//
//	private List<List<Long>> computeSpeedUp(List<Node> readyNodes, List<Integer> cores, long[] coreTime, long systemTime,
//			List<List<Node>> localRunqueue, List<List<Node>> history_level1, List<List<Node>> history_level2, List<Node> history_level3) {
//
//		List<List<Long>> speedUpTable = new ArrayList<>();
//
//		for (int i = 0; i < readyNodes.size(); i++) {
...
//				long WCET = n.getWCET();
//
//				Pair<Pair<Long, Double>, Integer> cacheRes = n.crp.computeET(-1, history_level1, history_level2, history_level3, n, core,
//						true, localRunqueue.get(core).stream().mapToLong(c -> c.expectedETPerCore[k]).sum(), 0, false);
//
