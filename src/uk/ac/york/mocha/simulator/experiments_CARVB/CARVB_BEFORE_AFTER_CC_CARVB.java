...
public class CARVB_BEFORE_AFTER_CC_CARVB {
		...
		for (int i = 0; i < nop; i++) {
			...
			runners.add(new Thread(new Runnable() {
				...
				public void run() {
					...
					String fileName = "/before_after_carvb" + "_" + cores + "_" + judgement + "_" + effectFactor + "_" + id
							+ ".txt";
	...
	public static void write(Pair<Pair<double[], double[]>, Double> r, int cores, double judgement, int id,
		...
		String folderName = "result/" + "faults_new/";
		String fileName = "/before_after_carvb" + "_" + cores + "_" + judgement + "_" + effectFactor + "_" + id + ".txt";
