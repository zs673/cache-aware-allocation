...
public class SemiWorkConversing {
...
//			System.out.println(
//					"DAG " + d.getName() + ", CoreNum: " + i + ", delay: " + delay + ", total response: " + response);
...
//		System.out.println(
//				"*** DAG " + d.getName() + ", CoreNum: " + best_core + ", total response: " + best_response_time);
