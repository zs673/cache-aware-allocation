...
saveas(gcf,strcat(path_figs, 'ep_recency.eps'), 'epsc');
...
saveas(gcf,strcat(path_figs, 'ep_recency_curve.eps'), 'epsc');
...
saveas(gcf,strcat(path_figs, 'ep_recency_step.eps'), 'epsc');
