...
%     end
    ...
    if task == 1
        set(gca,'xticklabel',xticklables);
         xlabel({'\fontsize{12}DAG-1                                                      DAG-2'; '\fontsize{14}Instances of DAG task'},'FontSize', 14) 
%          'DAG-1';
    else
        set(gca,'xticklabel',xticklables);
        xlabel({'\fontsize{12}DAG-1                                                      DAG-2';'\fontsize{14}Instances of DAG task'})
...
saveas(gcf,strcat(path_figs,'ep_',metric,num2str(task),'.png'));
