...
if __name__ == "__main__":
    ...
    # test vector
    # G = {{1:[2,3,4,5,9],2:[9],3:[6,7,8],4:[7],5:[7,8],6:[9],7:[9],8:[9],9:[]}，{1:[2,3,4,5,9],2:[9],3:[6,7,8],4:[7],5:[7,8],6:[9],7:[9],8:[9],9:[]}，{1:[2,3,4,5,9],2:[9],3:[6,7,8],4:[7],5:[7,8],6:[9],7:[9],8:[9],9:[]}}
    # C = {{1:4581,2:17559,3:9352,4:7826,5:8589,6:12215,7:9543,8:15078,9:11261}，{1:4581,2:17559,3:9352,4:7826,5:8589,6:12215,7:9543,8:15078,9:11261}，{1:4581,2:17559,3:9352,4:7826,5:8589,6:12215,7:9543,8:15078,9:11261}}
    # prio = {{1:9,2:8,3:7,4:6,5:5,6:4,7:3,8:2,9:1}，{1:9,2:8,3:7,4:6,5:5,6:4,7:3,8:2,9:1}，{1:9,2:8,3:7,4:6,5:5,6:4,7:3,8:2,9:1}}
    # n_cores = 8
    # overide_prio = 0
