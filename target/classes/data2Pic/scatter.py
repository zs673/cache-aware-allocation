...
def scatter(x, data, PATH):
    ...
    for i in range(0, METHOD_NUM):
        ...
        med_data = np.around(np.mean(method_data, axis=1), 3)
        plt.scatter(x, med_data, s=3, c=color[i], marker = 'o', label=labels[i])
        print("makespan:", np.mean(med_data))
    plt.xlim(0, END)
    # plt.ylim(0.0, 1.1)

    plt.xticks(fontsize=17)  # Adjust the fontsize for the x-axis ticks
    plt.yticks(fontsize=17)
    plt.ylabel('Normalized makespan', fontsize=20)
    plt.xlabel('Workload of the DAG task', fontsize=20)
    plt.legend(prop={'size':18}, loc='lower right', markerscale=5, handletextpad=0.1, labelspacing=0.2, borderpad=0.2)  
    plt.tight_layout()
    # plt.show()
    plt.savefig(PATH + "scatter.pdf", dpi=300, format="pdf")
...
def scatter_cache(x, data, PATH, flag):
    ...
    if flag == "L1":
        plt.ylabel('Recency miss rate', fontsize=20)
    elif flag == "L2":
        plt.ylabel('Recency miss rate', fontsize=20)
    plt.xlabel('Workload of the DAG task', fontsize=20)
    plt.legend(prop={'size':18}, loc=local,  markerscale=5, handletextpad=0.1, labelspacing=0.2, borderpad=0.2)  
    plt.tight_layout()
    # plt.show()
    plt.savefig(PATH + "cache_" + flag + ".pdf", dpi=300, format="pdf")
...
def main():
    # PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/util.txt"
    # PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/exp_L2cluster/cache/"
    # # PATH2 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/exp1_2/"
    ...
    PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache1/util.txt"
    PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache1/"
    # x = pd.read_table(PATH, sep=',', header=None).iloc[:, 0:TOT_NOS].values
    # x = x[0, :NUM] * 144
    data = pd.read_table(PATH1 + '/makespan_1_1.3382359549729022.txt', sep=',', header=None)
    data = data.iloc[:, 0:10]
    y = data.values

    PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache2/util.txt"
    PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache2/"
    ...
    data2 = pd.read_table(PATH1 + '/makespan_1_1.3008198331663061.txt', sep=',', header=None)
    data2 = data2.iloc[:, 0:10]
    y2 = data2.values
    # y = np.append(y, y2, axis=0)

    PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache3/util.txt"
    PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache3/"
    # PATH2 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/exp1_2/"
    # x3 = pd.read_table(PATH, sep=',', header=None).iloc[:, 0:TOT_NOS].values
    # x3 = x3[0, :NUM] * 144
    data3 = pd.read_table(PATH1 + '/makespan_1_0.3587371259061407.txt', sep=',', header=None)
    data3 = data3.iloc[:, 0:10]
    y3 = data3.values

    PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache4/util.txt"
    PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache4/"
    # PATH2 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/exp1_2/"
    # x4 = pd.read_table(PATH, sep=',', header=None).iloc[:, 0:TOT_NOS].values
    # x4 = x4[0, :NUM] * 144
    data4 = pd.read_table(PATH1 + '/makespan_1_1.363123500987001.txt', sep=',', header=None)
    ...
    PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache1/util.txt"
    PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache1/"
    cache_data = pd.read_table(PATH1 + '/cache_1_1.3382359549729022.txt', sep=',', header=None)
    ...
    PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache2/util.txt"
    PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache2/"
    cache_data = pd.read_table(PATH1 + '/cache_1_1.3008198331663061.txt', sep=',', header=None)
    cache_data = cache_data.iloc[0:METHOD_NUM*NUM, 0:4]
    y = cache_data.values
    ...
    PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache3/util.txt"
    PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache3/"
    cache_data = pd.read_table(PATH1 + '/cache_1_0.3587371259061407.txt', sep=',', header=None)
    cache_data = cache_data.iloc[0:METHOD_NUM*NUM, 0:4]
    y = cache_data.values
    ...
    PATH = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache4/util.txt"
    PATH1 = "E:/Code/Java/cache-aware-allocation-main/result/1017_noupdateS/cache4/"
    cache_data = pd.read_table(PATH1 + '/cache_1_1.363123500987001.txt', sep=',', header=None)
    cache_data = cache_data.iloc[0:METHOD_NUM*NUM, 0:4]
    y = cache_data.values
