...
saveas(gcf,strcat('../CARVB_figs/ep_predict_compare_medain_divide.png'));
saveas(gcf,strcat('../CARVB_figs/ep_predict_compare_medain_divide.eps'), 'epsc');
...
set(gcf, 'PaperSize', [25 25])
saveas(gcf,strcat('../CARVB_figs/ep_predict_compare_divide_',num2str(p2),'.png'));
saveas(gcf,strcat('../CARVB_figs/ep_predict_compare_divide_',num2str(p2),'.eps'), 'epsc');
% end
...
set(gcf, 'PaperSize', [25 25])
saveas(gcf,strcat('../CARVB_figs/ep_predict_compare_diff_divide_',num2str(p1),'_',num2str(p2),'.png'));
saveas(gcf,strcat('../CARVB_figs/ep_predict_compare_diff_divide_',num2str(p1),'_',num2str(p2),'.eps'), 'epsc');
