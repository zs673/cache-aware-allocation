    ...
    for judgement = judgements
        for effect = effects
            ...
            for i = 1:6
                ...
                saveas(gcf,strcat('../CARVB_figs/carvb_cc_distribution_',num2str(core),'_','0.1','_',types_names(i),'.eps'), 'epsc');
                saveas(gcf,strcat('../CARVB_figs/carvb_cc_distribution_',num2str(core),'_','0.1','_',types_names(i),'.png'));
