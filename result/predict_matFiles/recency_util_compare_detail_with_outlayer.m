...
saveas(gcf,strcat('figs/ep_util_compare_delay_outlayer.png'));
saveas(gcf,strcat('figs/ep_util_compare_delay_outlayer.eps'), 'epsc');
...
set(gcf, 'PaperSize', [25 25])
saveas(gcf,strcat('figs/ep_util_compare_et_outlayer.png'));
saveas(gcf,strcat('figs/ep_util_compare_et_outlayer.eps'), 'epsc');