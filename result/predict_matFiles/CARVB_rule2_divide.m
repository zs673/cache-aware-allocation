...
%     set(h,'FontSize',12);
    ...
    saveas(gcf,strcat('../figs/ep_predict_rule2_compare_diff_divide_',num2str(p1),'_',num2str(p2),'.png'));
    saveas(gcf,strcat('../figs/ep_predict_rule2_compare_diff_divide_',num2str(p1),'_',num2str(p2),'.eps'), 'epsc');
