...
for util = uStart:uEnd
    ...
    for m=1:methodNum
        ...
        data_per_util =[data_per_util reshape(datam(:,endIns),[],1)];
    end
...
set(gcf, 'PaperSize', [25 25])
saveas(gcf,strcat('../figs/ep_predict_compare_diff.png'));
saveas(gcf,strcat('../figs/ep_predict_compare_diff.eps'), 'epsc');
...
set(gcf, 'PaperSize', [25 25])
saveas(gcf,strcat('../figs/ep_predict_compare_diff_norm.png'));
saveas(gcf,strcat('../figs/ep_predict_compare_diff_norm.eps'), 'epsc');
