...
% ylim([13000 17000]);
xticks = sum(1:methodToDisplay)/methodToDisplay : methodToDisplay : uEnd*methodToDisplay+1;
...
%     set(h,'FontSize',12);
    ...
    set(gcf, 'PaperSize', [25 25])
    saveas(gcf,strcat('../figs/ep_predict_compare_divide_',num2str(p2),'.png'));
    saveas(gcf,strcat('../figs/ep_predict_compare_divide_',num2str(p2),'.eps'), 'epsc');
% end
...
%     set(h,'FontSize',12);
    ...
    set(gcf, 'PaperSize', [25 25])
    saveas(gcf,strcat('../figs/ep_predict_compare_diff_divide_',num2str(p1),'_',num2str(p2),'.png'));
    saveas(gcf,strcat('../figs/ep_predict_compare_diff_divide_',num2str(p1),'_',num2str(p2),'.eps'), 'epsc');
